/*
 * Copied and pasted from repl
 * Shreeshail Pokharel @02931612
 * Other Collaborators: Manish, Aayush, Nikesh 
 * 
 * Worked on generalized pipes. Our shell
 * can handle any number of pipes as long as the prompt
 * is not longer than the MAX_COMMAND_LINE_LEN i.e. 1024
*/
